...
function QuoteCard({ item, colorIndex }: { item: QuoteItem; colorIndex: number }) {
  ...
  return (
    <blockquote className={`flex h-[180px] md:h-[225px] min-h-[180px] md:min-h-[225px] w-max min-w-[240px] md:min-w-[280px] max-w-[380px] md:max-w-[450px] flex-shrink-0 flex-col overflow-hidden border border-gray-600 border-l-4 ${borderColor} rounded-lg bg-[#0d0d0d] pl-4 pr-4 py-4 md:pl-6 md:pr-6 md:py-8`}>
      {rating != null && (
